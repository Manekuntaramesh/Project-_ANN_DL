...
st.set_page_config(page_title="Tensorflow",
                   layout="wide",
                   page_icon="🤖")
...
def app():
    ...
    dataset_options =  {
        "ushape": r"C:\rock\1.ushape.csv",
        "concerticcir1": r"C:\rock\2.concerticcir1.csv",
        "concertriccir2": r"C:\rock\3.concertriccir2.csv",
        "linearsep": r"C:\rock\4.linearsep.csv",
        "outlier": r"C:\rock\5.outlier.csv",
        "overlap": r"C:\rock\6.overlap.csv",
        "xor": r"C:\rock\7.xor.csv",
        "twospirals": r"C:\rock\8.twospirals.csv"
    }
